...
const texts = {
	EN: {
		...
		description:
			"No matter the size of your business, you will be able to benefit for any kinds of idea.",
		subtitle: "The Easiest Way",
		description2:
			" We help you create and manage all successful use content can make your project come true.",
		...
		<>
			...
			<div className="container mx-auto px-4 py-12 flex flex-col md:flex-row items-center">
				...
				<div className="md:w-1/2 md:pl-12">
					...
					<p className="text-xl text-gray-600 mb-6">{texts.EN.description}</p>
					<div className="mb-6">
						<div className="flex items-start mb-2">
							<Check className="w-5 h-5 text-green-500 mr-2 mt-1" />
							<div>
								<h3 className="font-semibold text-lg">{texts.EN.subtitle}</h3>
								<p className="text-gray-600">{texts.EN.description2}</p>
							</div>
						</div>
					</div>
