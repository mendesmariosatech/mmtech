      ...
      <nav className="flex items-center justify-between p-4 bg-white">
        ...
        <div className="sm:hidden md:flex space-x-4">
          ...
          <Button
            // href="/pages"
            variant={"link"}
            className="text-gray-600 hover:text-gray-800">PAGES</Button>
          <Button
            // href="/services"
            variant={"link"}
            className="text-gray-600 hover:text-gray-800">SERVICES</Button>
          <Button
            // href="/elements"
            variant={"link"}
            className="text-gray-600 hover:text-gray-800">ELEMENTS</Button>
          <Button
            // href="/shop"
            variant={"link"}
            className="text-gray-600 hover:text-gray-800">SHOP</Button>
          <Button
            // href="/blog"
            variant={"link"}
            className="text-gray-600 hover:text-gray-800">BLOG</Button>
        </div>
