...
const people: Person[] = [
	{
		...
		impact:
			"Desenvolveu algoritmos que melhoraram a eficiência energética em 30%",
	...
	},
	{
		...
		description:
			"Líder em pesquisas sobre tratamentos inovadores para doenças raras",
		quote: "A cura está na persistência e na colaboração",
		impact:
			"Suas descobertas abriram caminho para novos tratamentos promissores",
	...
	},
	{
		...
		impact:
			"Seus projetos reduziram o consumo de energia em edifícios em até 50%",
	...
	},
	{
		...
		impact:
			"Liderou campanhas que preservaram mais de 100.000 hectares de floresta",
		...
		<div className="container mx-auto p-4">
			...
			<div className="grid gap-6 grid-cols-1 md:grid-cols-3">
				...
				{people.slice(0, 3).map((person, index) => (
					<Card
						key={person.id}
						className="overflow-hidden border-gray-200 shadow-lg backdrop-blur-sm bg-white/30"
					>
			...
			<div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
				{people.slice(3).map((person) => (
					<Card
						key={person.id}
						className="flex items-center p-4 space-x-4 border-gray-200 backdrop-blur-sm bg-white/30"
					>
